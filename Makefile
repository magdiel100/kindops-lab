.PHONY: bootstrap tree ansible-bootstrap bootstrap-kind destroy-kind recreate-kind phase1-check install-jenkins jenkins-port-forward phase2-check build-jenkins-agent
